...
export default function TimelineLeft(props) {
  return (
    <div className="flex flex-row-reverse md:contents">
      <div className="bg-yellow-300 text-yellow-500 font-sans bg-opacity-10 backdrop-filter backdrop-blur col-start-1 col-end-5 p-4 rounded-xl my-4 md:ml-auto md:mr-0 mr-auto shadow-md">
        <div>
